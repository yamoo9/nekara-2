...
import { Button } from './ThemeModeToggler.styled';
...
export const ThemeModeToggler = (props) => {
  ...
  const IconComponent = useMemo(() => {
    return ThemeModeToggler[theme.mode === 'light' ? 'MoonIcon' : 'SunIcon'];
  }, [theme.mode]);
...
ThemeModeToggler.MoonIcon = () => {
  ...
  return (
    <motion.svg width="1em" height="1em" viewBox="0 0 50 50" key="moon">
      <motion.path
