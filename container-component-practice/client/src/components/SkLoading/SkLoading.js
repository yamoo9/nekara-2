...
import assetConnect from './assets/spinner-connect.gif';
import assetGrow from './assets/spinner-grow.gif';
import assetLearn from './assets/spinner-learn.gif';
...
export function SkLoading() {
  ...
  return (
    <figure className={styles.component}>
      <img className={styles.image} src={assetLearn} alt="" />
    </figure>
  );
}
